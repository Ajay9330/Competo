...
export default function studentRegistrationForm() {
  ...
  return (
    ...
    <div className="">
        ...
        <div className='md:w-96 pt-4 md:border-2 md:border-blue-600 bg-white hover:border-blue-900 md:grid grid-cols-1 justify-items-center md:h-96 rounded-3xl hover:shadow-xl'>
